    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <hr>
                <button class="btn btn-primary float-right" data-toggle="modal" data-target="#create_modal">Nuevo</button>
                <br>
                <br>
                <hr>
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr v-for="item in articulos" :key="item.id">
                            ...
                            <td>{{ item.stock }}</td>
                            <td>
                                <button v-on:click="edit(item);" class="btn btn-warning" data-toggle="modal" data-target="#edit_modal">Editar</button>
                            </td>
                            <td>
                                <button v-on:click="destroy(item.id);" class="btn btn-danger">Eliminar</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="modal fade" id="create_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <div class="form">
                        ...
                        <div class="form-group">
                            ...
                            <textarea v-model="articulo.descripcion" class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <button v-on:click="store()" type="button" class="btn btn-primary">Guardar</button>
                </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                    <button v-on:click="update()" type="button" class="btn btn-primary">Actualizar</button>
                </div>
                </div>
            </div>
        </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            async update(){
                const res = await axios.put('/articulo/'+this.articulo.id,this.articulo);
                if(res.data.id > 0){
